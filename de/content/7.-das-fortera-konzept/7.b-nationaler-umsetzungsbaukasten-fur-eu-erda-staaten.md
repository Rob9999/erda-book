...
## 7.B.3 Kompaktes Abdeckungs-Register (27 EU-Staaten)

Hier ist das **kompakte Abdeckungs-Register** für alle **27 EU-Staaten**: **Staat → Archetyp → Missionstypen (M1–M3)**.

### Missionstypen-Legende (Codes)

- **E** = Energie/Netz/Speicher/Reserven/Microgrids
- **L** = Logistik/Häfen/Korridore/Green-Lanes/Depots
- **I** = Industrie/Serienfertigung/Zulieferketten (nicht-militärisch)
- **C** = Cyber/Cloud/GovTech/KRITIS-IT-Baselines/SOC
- **S** = Standards/Test/Zertifizierung/Audit/Compliance-Skalierung
- **D** = Dual-Use/Surge-Produktion/Umrüstung (Skalierung im Krisenfall)
- **R** = Rohstoffe/Chemie-Vorprodukte/Recycling/Materialketten
- **T** = Maritim/Repair/Offshore/Ship-Industrie (als eigener Hebel)
- **F** = Finanzierung/Garantien/Project-Scoring
- **P** = Pharma/MedTech-Lieferfähigkeit/Buffer-Stocks
- **Z** = Zivilschutz-/Resilienz-Governance (Übungen/Rotation/Notbeschaffung als Schwerpunkt)

---

### 27 Staaten → Archetypen → Missionstypen (M1/M2/M3)

- **Österreich** — Industrie-Knoten / Energie-Systemstabilität — **E / I / C**
- **Belgien** — Logistik-Drehscheibe / Industrie-Cluster — **L / R / S**
- **Bulgarien** — Fertigungs-Aufbau / Resilienz-Korridor — **E / I / C**
- **Kroatien** — Logistik-Tor / Industrie-Nischen — **L / T / E**
- **Zypern** — Dienstleistungs-Knoten / Energie-Korridor — **E / L / C**
- **Tschechien** — Industrie-Zuliefer-Schwerpunkt — **I / E / D**
- **Dänemark** — Energie-Ankerstaat / Maritime Logistik — **E / E / S**
- **Estland** — High-Tech-Knoten / Cyber-Resilienz — **C / C / C**
- **Finnland** — Resilienz-Anker / Clean-Tech- & Rohstoff-Cluster — **E / R / Z**
- **Frankreich** — Strategischer Industrieanker / Energie- & Dual-Use-Basis — **E / D / S**
- **Deutschland** — Industrie-Kern / Skalierungsland — **E / I / L**
- **Griechenland** — Südost-Tor / Maritime Logistik & Energie-Korridor — **L / E / T**
- **Ungarn** — Fertigungs-Knoten / Zuliefer-Ketten — **I / E / S**
- **Irland** — High-Tech-Dienstleistungen / Pharma- & Digital-Knoten — **C / P / E**
- **Italien** — Industrie-Schwergewicht / Maritime-Knoten — **E / D / L**
- **Lettland** — Frontline-Resilienz / Logistik-Korridor — **L / C / E**
- **Litauen** — Frontline-Resilienz / High-Tech-Nische — **C / I / E**
- **Luxemburg** — Finanz-/Regel-Knoten / High-Trust-Infra — **F / S / C**
- **Malta** — Maritime Logistik / Dienstleistungs-Resilienz — **L / E / C**
- **Niederlande** — High-Tech-Knoten / Logistik-Drehscheibe — **I / L / S**
- **Polen** — Ostflanken-Anker / Industrie- & Logistik-Skalierung — **I / L / E**
- **Portugal** — Atlantik-Gateway / Energie- & Hafen-Knoten — **L / E / T**
- **Rumänien** — Schwarzmeer-Korridor / Energie- & Fertigungsaufbau — **L / E / I**
- **Slowakei** — Präzisionsfertigung / Serienfähigkeit — **I / D / E**
- **Slowenien** — Adriatisches Tor / Präzisions-Industrie — **L / E / I**
- **Spanien** — Erneuerbaren-Powerhouse / Gateway — **E / I / T**
- **Schweden** — Industrie-Resilienz / Clean-Steel & High-Tech — **E / R / D**

---

### Quick-Scan: Überdeckung & Lücken (81 Missionslots = 27×3)

**Häufigkeit nach Missionstyp (Anzahl Missionslots):**
...
**Auffällige Redundanzen (nicht schlecht – aber sichtbar):**

- **Energie (E)** ist der klare „Default“ fast überall.
- **Estland** ist bewusst **C/C/C** (starkes Spezialisierungs-Signal).
- **Dänemark** ist **E/E/S** (doppelter Energie-Hebel plus Standardisierung).

**Seltene/knappe Abdeckung (potenzielle Lücken, falls EU-weit wichtig):**

- **F (Finanzierungs-Backbone)** nur **Luxemburg**
- **P (Pharma/MedTech-Resilienz)** nur **Irland**
- **Z (Zivilschutz-Governance als Hauptmission)** nur **Finnland**
- **R (Rohstoffe/Recycling)** nur **Belgien/Finnland/Schweden**
- **T (Maritime Repair/Offshore)** nur **Kroatien/Griechenland/Portugal/Spanien**
