...
本作品の利用・加工・変換は、人工知能、機械学習、その他の自動化システムによるものを含め、すべて同一のオープンライセンス条件に従います。

これは派生作品、AI が生成したコンテンツ、リミックス・プロジェクト、アルゴリズムによって変換された形式を明示的に含みます。

目的は、民主的で創造的かつ多様な社会における、共有され開かれた知の未来です。
