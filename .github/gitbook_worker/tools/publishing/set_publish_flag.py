...
def main():
    ...
    a = p.parse_args()
    try:
        r = set_publish_flags(manifest_path=Path(a.publish) if a.publish else None, commit=a.commit, base=a.base, reset_others=a.reset_others, dry_run=a.dry_run, debug=a.debug)
