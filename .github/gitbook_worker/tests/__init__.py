...
GH_TEST_TMP_DIR.mkdir(exist_ok=True)

# Logs
GH_TEST_LOGS_DIR = GH_TEST_TMP_DIR / "logs"
GH_TEST_LOGS_DIR.mkdir(exist_ok=True)

# Output
GH_TEST_OUTPUT_DIR = GH_TEST_TMP_DIR / "output"
GH_TEST_OUTPUT_DIR.mkdir(exist_ok=True)

# Artifacts
GH_TEST_ARTIFACTS_DIR = GH_TEST_TMP_DIR / "artifacts"
GH_TEST_ARTIFACTS_DIR.mkdir(exist_ok=True)

# Test Data
GH_TEST_DATA_DIR = pathlib.Path(__file__).parent / "data"
GH_TEST_DATA_DIR.mkdir(exist_ok=True)
