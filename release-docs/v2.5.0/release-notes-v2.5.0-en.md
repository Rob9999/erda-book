...
- Release metadata gate applied: README date, `book.json`, CFF files and `.zenodo.json` synchronised to 2026-05-12
...
- de (source of truth)
- en (synchronised, draft/review; no native final full approval in this release)
