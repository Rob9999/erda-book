...
**Letzte Aktualisierung / Last updated:** 2026-05-12 (v2.5.0 final metadata examples)
...
|---|---|---|---|
| 1 | `README.md` | Badge-URL, **Current version**, **As of (date)**, **Codename**, ToC-Einträge (DE+EN), Release-Überschriften (DE+EN) | `v2.5.0`, `2026-05-12` |
| 2 | `CITATION.cff` (Root) | `version`, `date-released` | `"2.5.0"`, `'2026-05-12'` |
...
| 7 | `de/book.json` | `"date"` | `"2026-05-12"` |
| 8 | `en/book.json` | `"date"` | `"2026-05-12"` |
